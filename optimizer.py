...
# GENERAL
#   idea: grow generation_size and mut_rate as you get further (bc innovation is very slow after 400 generations or so)
...
#   multiprocess more things (e.g. the mapping fitness onto ents)
#   more optimizations (?)
